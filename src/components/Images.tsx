        ...
        <div className="relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="bg-black bg-opacity-50 px-4 py-2 rounded-lg">
              ...
              <span id={`processing-text-${image.id}`} className="text-white font-medium">Processing...</span>
            </div>
          </div>
        </div>
      ) : (
      ...
      <div className="p-3 border-t border-gray-100">
        <div className="flex justify-center gap-2">
          ...
          >
            ...
            <span id={`btn-delete-label-${image.id}`} className="text-sm text-gray-700">Delete</span>
          </button>
          ...
          >
            ...
            <span id={`btn-edit-label-${image.id}`} className="text-sm text-gray-700">Edit</span>
          </button>
          ...
          >
            ...
            <span id={`btn-download-label-${image.id}`} className="text-sm text-gray-700">Download</span>
          </a>
        </div>
      </div>
    )}
